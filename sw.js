const CACHE_NAME = 'krishi-mcq-v180-e2i6r7l';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=e2i6r7l', r); }),
          ...
          fetch('./js/canvas_charts.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=e2i6r7l', r); }),

          fetch('./js/pwa_helpers.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=e2i6r7l', r); }),
          fetch('./js/app.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=e2i6r7l', r); }),
          fetch('./js/elite_animations_controller.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=e2i6r7l', r); }),
          fetch('./js/elite_3d_engine.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=e2i6r7l', r); }),
          ...
          fetch('./js/sqlite_db.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=e2i6r7l', r); }),
          fetch('./js/krishi_idb.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=e2i6r7l', r); }),
          fetch('./js/krishi_worker.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=e2i6r7l', r); }),
          ...
          fetch('./js/voice_assistant.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=e2i6r7l', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=e2i6r7l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=e2i6r7l', r); }),
