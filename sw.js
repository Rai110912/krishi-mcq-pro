const CACHE_NAME = 'krishi-mcq-v167-jpdevup';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=jpdevup', r); }),
          ...
          fetch('./js/canvas_charts.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=jpdevup', r); }),

          fetch('./js/pwa_helpers.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=jpdevup', r); }),
          fetch('./js/app.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=jpdevup', r); }),
          fetch('./js/elite_animations_controller.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=jpdevup', r); }),
          fetch('./js/elite_3d_engine.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=jpdevup', r); }),
          ...
          fetch('./js/sqlite_db.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=jpdevup', r); }),
          fetch('./js/krishi_idb.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=jpdevup', r); }),
          fetch('./js/krishi_worker.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=jpdevup', r); }),
          ...
          fetch('./js/voice_assistant.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=jpdevup', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=jpdevup', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=jpdevup', r); }),
