const CACHE_NAME = 'krishi-mcq-v182-jb2ycfe';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=jb2ycfe', r); }),
          ...
          fetch('./js/canvas_charts.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=jb2ycfe', r); }),

          fetch('./js/pwa_helpers.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=jb2ycfe', r); }),
          fetch('./js/app.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=jb2ycfe', r); }),
          fetch('./js/elite_animations_controller.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=jb2ycfe', r); }),
          fetch('./js/elite_3d_engine.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=jb2ycfe', r); }),
          ...
          fetch('./js/sqlite_db.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=jb2ycfe', r); }),
          fetch('./js/krishi_idb.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=jb2ycfe', r); }),
          fetch('./js/krishi_worker.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=jb2ycfe', r); }),
          ...
          fetch('./js/voice_assistant.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=jb2ycfe', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=jb2ycfe', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=jb2ycfe', r); }),
