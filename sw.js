const CACHE_NAME = 'krishi-mcq-v87-sz8g2tr';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=sz8g2tr', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=sz8g2tr', r); }),
          ...
          fetch('./js/canvas_charts.js?v=sz8g2tr', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=sz8g2tr', r); }),
          fetch('./js/spaced_rep.js?v=sz8g2tr', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=sz8g2tr', r); }),
          fetch('./js/pwa_helpers.js?v=sz8g2tr', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=sz8g2tr', r); }),
          fetch('./js/app.js?v=sz8g2tr', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=sz8g2tr', r); }),
          fetch('./js/elite_animations_controller.js?v=sz8g2tr', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=sz8g2tr', r); }),
          fetch('./js/elite_3d_engine.js?v=sz8g2tr', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=sz8g2tr', r); }),
          ...
          fetch('./js/sqlite_db.js?v=sz8g2tr', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=sz8g2tr', r); }),
