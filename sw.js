const CACHE_NAME = 'krishi-mcq-v174-xiaxegk';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=xiaxegk', r); }),
          ...
          fetch('./js/canvas_charts.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=xiaxegk', r); }),

          fetch('./js/pwa_helpers.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=xiaxegk', r); }),
          fetch('./js/app.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=xiaxegk', r); }),
          fetch('./js/elite_animations_controller.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=xiaxegk', r); }),
          fetch('./js/elite_3d_engine.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=xiaxegk', r); }),
          ...
          fetch('./js/sqlite_db.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=xiaxegk', r); }),
          fetch('./js/krishi_idb.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=xiaxegk', r); }),
          fetch('./js/krishi_worker.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=xiaxegk', r); }),
          ...
          fetch('./js/voice_assistant.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=xiaxegk', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=xiaxegk', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=xiaxegk', r); }),
