const CACHE_NAME = 'krishi-mcq-v173-irm7n0w';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=irm7n0w', r); }),
          ...
          fetch('./js/canvas_charts.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=irm7n0w', r); }),

          fetch('./js/pwa_helpers.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=irm7n0w', r); }),
          fetch('./js/app.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=irm7n0w', r); }),
          fetch('./js/elite_animations_controller.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=irm7n0w', r); }),
          fetch('./js/elite_3d_engine.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=irm7n0w', r); }),
          ...
          fetch('./js/sqlite_db.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=irm7n0w', r); }),
          fetch('./js/krishi_idb.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=irm7n0w', r); }),
          fetch('./js/krishi_worker.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=irm7n0w', r); }),
          ...
          fetch('./js/voice_assistant.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=irm7n0w', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=irm7n0w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=irm7n0w', r); }),
