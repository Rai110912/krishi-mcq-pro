const CACHE_NAME = 'krishi-mcq-v132-w0andde';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=w0andde', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=w0andde', r); }),
          ...
          fetch('./js/canvas_charts.js?v=w0andde', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=w0andde', r); }),

          fetch('./js/pwa_helpers.js?v=w0andde', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=w0andde', r); }),
          fetch('./js/app.js?v=w0andde', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=w0andde', r); }),
          fetch('./js/elite_animations_controller.js?v=w0andde', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=w0andde', r); }),
          fetch('./js/elite_3d_engine.js?v=w0andde', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=w0andde', r); }),
          ...
          fetch('./js/sqlite_db.js?v=w0andde', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=w0andde', r); }),
