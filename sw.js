const CACHE_NAME = 'krishi-mcq-v90-pj17oxt';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=pj17oxt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=pj17oxt', r); }),
          ...
          fetch('./js/canvas_charts.js?v=pj17oxt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=pj17oxt', r); }),
          fetch('./js/spaced_rep.js?v=pj17oxt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=pj17oxt', r); }),
          fetch('./js/pwa_helpers.js?v=pj17oxt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=pj17oxt', r); }),
          fetch('./js/app.js?v=pj17oxt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=pj17oxt', r); }),
          fetch('./js/elite_animations_controller.js?v=pj17oxt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=pj17oxt', r); }),
          fetch('./js/elite_3d_engine.js?v=pj17oxt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=pj17oxt', r); }),
          ...
          fetch('./js/sqlite_db.js?v=pj17oxt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=pj17oxt', r); }),
