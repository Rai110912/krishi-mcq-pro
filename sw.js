const CACHE_NAME = 'krishi-mcq-v197-vss7c41';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=vss7c41', r); }),
          ...
          fetch('./js/canvas_charts.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=vss7c41', r); }),

          fetch('./js/pwa_helpers.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=vss7c41', r); }),
          fetch('./js/app.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=vss7c41', r); }),
          fetch('./js/elite_animations_controller.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=vss7c41', r); }),
          fetch('./js/elite_3d_engine.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=vss7c41', r); }),
          ...
          fetch('./js/sqlite_db.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=vss7c41', r); }),
          fetch('./js/krishi_idb.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=vss7c41', r); }),
          fetch('./js/krishi_worker.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=vss7c41', r); }),
          ...
          fetch('./js/voice_assistant.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=vss7c41', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=vss7c41', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=vss7c41', r); }),
