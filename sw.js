const CACHE_NAME = 'krishi-mcq-v172-trbbunx';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=trbbunx', r); }),
          ...
          fetch('./js/canvas_charts.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=trbbunx', r); }),

          fetch('./js/pwa_helpers.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=trbbunx', r); }),
          fetch('./js/app.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=trbbunx', r); }),
          fetch('./js/elite_animations_controller.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=trbbunx', r); }),
          fetch('./js/elite_3d_engine.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=trbbunx', r); }),
          ...
          fetch('./js/sqlite_db.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=trbbunx', r); }),
          fetch('./js/krishi_idb.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=trbbunx', r); }),
          fetch('./js/krishi_worker.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=trbbunx', r); }),
          ...
          fetch('./js/voice_assistant.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=trbbunx', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=trbbunx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=trbbunx', r); }),
