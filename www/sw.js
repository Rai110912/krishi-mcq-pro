const CACHE_NAME = 'krishi-mcq-v84-v6xmmw3';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=v6xmmw3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=v6xmmw3', r); }),
          ...
          fetch('./js/canvas_charts.js?v=v6xmmw3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=v6xmmw3', r); }),
          fetch('./js/spaced_rep.js?v=v6xmmw3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=v6xmmw3', r); }),
          fetch('./js/pwa_helpers.js?v=v6xmmw3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=v6xmmw3', r); }),
          fetch('./js/app.js?v=v6xmmw3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=v6xmmw3', r); }),
          fetch('./js/elite_animations_controller.js?v=v6xmmw3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=v6xmmw3', r); }),
          fetch('./js/elite_3d_engine.js?v=v6xmmw3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=v6xmmw3', r); }),
          ...
          fetch('./js/sqlite_db.js?v=v6xmmw3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=v6xmmw3', r); }),
