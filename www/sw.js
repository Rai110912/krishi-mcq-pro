const CACHE_NAME = 'krishi-mcq-v137-wf1i59x';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=wf1i59x', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=wf1i59x', r); }),
          ...
          fetch('./js/canvas_charts.js?v=wf1i59x', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=wf1i59x', r); }),

          fetch('./js/pwa_helpers.js?v=wf1i59x', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=wf1i59x', r); }),
          fetch('./js/app.js?v=wf1i59x', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=wf1i59x', r); }),
          fetch('./js/elite_animations_controller.js?v=wf1i59x', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=wf1i59x', r); }),
          fetch('./js/elite_3d_engine.js?v=wf1i59x', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=wf1i59x', r); }),
          ...
          fetch('./js/sqlite_db.js?v=wf1i59x', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=wf1i59x', r); }),
