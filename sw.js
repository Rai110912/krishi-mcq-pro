const CACHE_NAME = 'krishi-mcq-v205-jul7q4u';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=jul7q4u', r); }),
          ...
          fetch('./js/canvas_charts.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=jul7q4u', r); }),

          fetch('./js/pwa_helpers.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=jul7q4u', r); }),
          fetch('./js/app.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=jul7q4u', r); }),
          fetch('./js/elite_animations_controller.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=jul7q4u', r); }),
          fetch('./js/elite_3d_engine.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=jul7q4u', r); }),
          ...
          fetch('./js/sqlite_db.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=jul7q4u', r); }),
          fetch('./js/krishi_idb.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=jul7q4u', r); }),
          fetch('./js/krishi_worker.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=jul7q4u', r); }),
          ...
          fetch('./js/voice_assistant.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=jul7q4u', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=jul7q4u', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=jul7q4u', r); }),
