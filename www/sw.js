const CACHE_NAME = 'krishi-mcq-v140-t152nib';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=t152nib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=t152nib', r); }),
          ...
          fetch('./js/canvas_charts.js?v=t152nib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=t152nib', r); }),

          fetch('./js/pwa_helpers.js?v=t152nib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=t152nib', r); }),
          fetch('./js/app.js?v=t152nib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=t152nib', r); }),
          fetch('./js/elite_animations_controller.js?v=t152nib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=t152nib', r); }),
          fetch('./js/elite_3d_engine.js?v=t152nib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=t152nib', r); }),
          ...
          fetch('./js/sqlite_db.js?v=t152nib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=t152nib', r); }),
