const CACHE_NAME = 'krishi-mcq-v105-n139qom';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=n139qom', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=n139qom', r); }),
          ...
          fetch('./js/canvas_charts.js?v=n139qom', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=n139qom', r); }),

          fetch('./js/pwa_helpers.js?v=n139qom', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=n139qom', r); }),
          fetch('./js/app.js?v=n139qom', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=n139qom', r); }),
          fetch('./js/elite_animations_controller.js?v=n139qom', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=n139qom', r); }),
          fetch('./js/elite_3d_engine.js?v=n139qom', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=n139qom', r); }),
          ...
          fetch('./js/sqlite_db.js?v=n139qom', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=n139qom', r); }),
