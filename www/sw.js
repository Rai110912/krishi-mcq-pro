const CACHE_NAME = 'krishi-mcq-v112-cvo71cq';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=cvo71cq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=cvo71cq', r); }),
          ...
          fetch('./js/canvas_charts.js?v=cvo71cq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=cvo71cq', r); }),

          fetch('./js/pwa_helpers.js?v=cvo71cq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=cvo71cq', r); }),
          fetch('./js/app.js?v=cvo71cq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=cvo71cq', r); }),
          fetch('./js/elite_animations_controller.js?v=cvo71cq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=cvo71cq', r); }),
          fetch('./js/elite_3d_engine.js?v=cvo71cq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=cvo71cq', r); }),
          ...
          fetch('./js/sqlite_db.js?v=cvo71cq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=cvo71cq', r); }),
