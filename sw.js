const CACHE_NAME = 'krishi-mcq-v185-akheuke';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=akheuke', r); }),
          ...
          fetch('./js/canvas_charts.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=akheuke', r); }),

          fetch('./js/pwa_helpers.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=akheuke', r); }),
          fetch('./js/app.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=akheuke', r); }),
          fetch('./js/elite_animations_controller.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=akheuke', r); }),
          fetch('./js/elite_3d_engine.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=akheuke', r); }),
          ...
          fetch('./js/sqlite_db.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=akheuke', r); }),
          fetch('./js/krishi_idb.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=akheuke', r); }),
          fetch('./js/krishi_worker.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=akheuke', r); }),
          ...
          fetch('./js/voice_assistant.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=akheuke', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=akheuke', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=akheuke', r); }),
