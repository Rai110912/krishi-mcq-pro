const CACHE_NAME = 'krishi-mcq-v121-ff83thp';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=ff83thp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=ff83thp', r); }),
          ...
          fetch('./js/canvas_charts.js?v=ff83thp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=ff83thp', r); }),

          fetch('./js/pwa_helpers.js?v=ff83thp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=ff83thp', r); }),
          fetch('./js/app.js?v=ff83thp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=ff83thp', r); }),
          fetch('./js/elite_animations_controller.js?v=ff83thp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=ff83thp', r); }),
          fetch('./js/elite_3d_engine.js?v=ff83thp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=ff83thp', r); }),
          ...
          fetch('./js/sqlite_db.js?v=ff83thp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=ff83thp', r); }),
