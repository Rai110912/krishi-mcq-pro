const CACHE_NAME = 'krishi-mcq-v77-lzqyqez';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=lzqyqez', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=lzqyqez', r); }),
          ...
          fetch('./js/canvas_charts.js?v=lzqyqez', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=lzqyqez', r); }),
          fetch('./js/spaced_rep.js?v=lzqyqez', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=lzqyqez', r); }),
          fetch('./js/pwa_helpers.js?v=lzqyqez', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=lzqyqez', r); }),
          fetch('./js/app.js?v=lzqyqez', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=lzqyqez', r); }),
          fetch('./js/elite_animations_controller.js?v=lzqyqez', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=lzqyqez', r); }),
          fetch('./js/elite_3d_engine.js?v=lzqyqez', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=lzqyqez', r); }),
          ...
          fetch('./js/sqlite_db.js?v=lzqyqez', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=lzqyqez', r); }),
