const CACHE_NAME = 'krishi-mcq-v120-zvrwpjt';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=zvrwpjt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=zvrwpjt', r); }),
          ...
          fetch('./js/canvas_charts.js?v=zvrwpjt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=zvrwpjt', r); }),

          fetch('./js/pwa_helpers.js?v=zvrwpjt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=zvrwpjt', r); }),
          fetch('./js/app.js?v=zvrwpjt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=zvrwpjt', r); }),
          fetch('./js/elite_animations_controller.js?v=zvrwpjt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=zvrwpjt', r); }),
          fetch('./js/elite_3d_engine.js?v=zvrwpjt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=zvrwpjt', r); }),
          ...
          fetch('./js/sqlite_db.js?v=zvrwpjt', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=zvrwpjt', r); }),
