const CACHE_NAME = 'krishi-mcq-v146-smnqjqu';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=smnqjqu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=smnqjqu', r); }),
          ...
          fetch('./js/canvas_charts.js?v=smnqjqu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=smnqjqu', r); }),

          fetch('./js/pwa_helpers.js?v=smnqjqu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=smnqjqu', r); }),
          fetch('./js/app.js?v=smnqjqu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=smnqjqu', r); }),
          fetch('./js/elite_animations_controller.js?v=smnqjqu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=smnqjqu', r); }),
          fetch('./js/elite_3d_engine.js?v=smnqjqu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=smnqjqu', r); }),
          ...
          fetch('./js/sqlite_db.js?v=smnqjqu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=smnqjqu', r); }),
