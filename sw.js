const CACHE_NAME = 'krishi-mcq-v142-jzkxxvl';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=jzkxxvl', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=jzkxxvl', r); }),
          ...
          fetch('./js/canvas_charts.js?v=jzkxxvl', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=jzkxxvl', r); }),

          fetch('./js/pwa_helpers.js?v=jzkxxvl', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=jzkxxvl', r); }),
          fetch('./js/app.js?v=jzkxxvl', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=jzkxxvl', r); }),
          fetch('./js/elite_animations_controller.js?v=jzkxxvl', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=jzkxxvl', r); }),
          fetch('./js/elite_3d_engine.js?v=jzkxxvl', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=jzkxxvl', r); }),
          ...
          fetch('./js/sqlite_db.js?v=jzkxxvl', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=jzkxxvl', r); }),
