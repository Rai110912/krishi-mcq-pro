const CACHE_NAME = 'krishi-mcq-v97-qyrzdzx';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=qyrzdzx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=qyrzdzx', r); }),
          ...
          fetch('./js/canvas_charts.js?v=qyrzdzx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=qyrzdzx', r); }),
          fetch('./js/spaced_rep.js?v=qyrzdzx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=qyrzdzx', r); }),
          fetch('./js/pwa_helpers.js?v=qyrzdzx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=qyrzdzx', r); }),
          fetch('./js/app.js?v=qyrzdzx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=qyrzdzx', r); }),
          fetch('./js/elite_animations_controller.js?v=qyrzdzx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=qyrzdzx', r); }),
          fetch('./js/elite_3d_engine.js?v=qyrzdzx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=qyrzdzx', r); }),
          ...
          fetch('./js/sqlite_db.js?v=qyrzdzx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=qyrzdzx', r); }),
