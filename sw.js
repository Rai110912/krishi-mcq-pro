const CACHE_NAME = 'krishi-mcq-v111-oivxdj3';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=oivxdj3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=oivxdj3', r); }),
          ...
          fetch('./js/canvas_charts.js?v=oivxdj3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=oivxdj3', r); }),

          fetch('./js/pwa_helpers.js?v=oivxdj3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=oivxdj3', r); }),
          fetch('./js/app.js?v=oivxdj3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=oivxdj3', r); }),
          fetch('./js/elite_animations_controller.js?v=oivxdj3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=oivxdj3', r); }),
          fetch('./js/elite_3d_engine.js?v=oivxdj3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=oivxdj3', r); }),
          ...
          fetch('./js/sqlite_db.js?v=oivxdj3', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=oivxdj3', r); }),
