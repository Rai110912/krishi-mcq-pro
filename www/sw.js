const CACHE_NAME = 'krishi-mcq-v129-h2g40k7';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=h2g40k7', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=h2g40k7', r); }),
          ...
          fetch('./js/canvas_charts.js?v=h2g40k7', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=h2g40k7', r); }),

          fetch('./js/pwa_helpers.js?v=h2g40k7', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=h2g40k7', r); }),
          fetch('./js/app.js?v=h2g40k7', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=h2g40k7', r); }),
          fetch('./js/elite_animations_controller.js?v=h2g40k7', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=h2g40k7', r); }),
          fetch('./js/elite_3d_engine.js?v=h2g40k7', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=h2g40k7', r); }),
          ...
          fetch('./js/sqlite_db.js?v=h2g40k7', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=h2g40k7', r); }),
