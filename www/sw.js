const CACHE_NAME = 'krishi-mcq-v75-oniqw9a';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=oniqw9a', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=oniqw9a', r); }),
          ...
          fetch('./js/canvas_charts.js?v=oniqw9a', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=oniqw9a', r); }),
          fetch('./js/spaced_rep.js?v=oniqw9a', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=oniqw9a', r); }),
          fetch('./js/pwa_helpers.js?v=oniqw9a', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=oniqw9a', r); }),
          fetch('./js/app.js?v=oniqw9a', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=oniqw9a', r); }),
          fetch('./js/elite_animations_controller.js?v=oniqw9a', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=oniqw9a', r); }),
          fetch('./js/elite_3d_engine.js?v=oniqw9a', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=oniqw9a', r); }),
          ...
          fetch('./js/sqlite_db.js?v=oniqw9a', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=oniqw9a', r); }),
