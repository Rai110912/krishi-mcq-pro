const CACHE_NAME = 'krishi-mcq-v130-36wm14j';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=36wm14j', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=36wm14j', r); }),
          ...
          fetch('./js/canvas_charts.js?v=36wm14j', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=36wm14j', r); }),

          fetch('./js/pwa_helpers.js?v=36wm14j', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=36wm14j', r); }),
          fetch('./js/app.js?v=36wm14j', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=36wm14j', r); }),
          fetch('./js/elite_animations_controller.js?v=36wm14j', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=36wm14j', r); }),
          fetch('./js/elite_3d_engine.js?v=36wm14j', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=36wm14j', r); }),
          ...
          fetch('./js/sqlite_db.js?v=36wm14j', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=36wm14j', r); }),
