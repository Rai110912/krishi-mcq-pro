const CACHE_NAME = 'krishi-mcq-v189-34j5edc';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=34j5edc', r); }),
          ...
          fetch('./js/canvas_charts.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=34j5edc', r); }),

          fetch('./js/pwa_helpers.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=34j5edc', r); }),
          fetch('./js/app.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=34j5edc', r); }),
          fetch('./js/elite_animations_controller.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=34j5edc', r); }),
          fetch('./js/elite_3d_engine.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=34j5edc', r); }),
          ...
          fetch('./js/sqlite_db.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=34j5edc', r); }),
          fetch('./js/krishi_idb.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=34j5edc', r); }),
          fetch('./js/krishi_worker.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=34j5edc', r); }),
          ...
          fetch('./js/voice_assistant.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=34j5edc', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=34j5edc', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=34j5edc', r); }),
