const CACHE_NAME = 'krishi-mcq-v198-fxujrwu';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=fxujrwu', r); }),
          ...
          fetch('./js/canvas_charts.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=fxujrwu', r); }),

          fetch('./js/pwa_helpers.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=fxujrwu', r); }),
          fetch('./js/app.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=fxujrwu', r); }),
          fetch('./js/elite_animations_controller.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=fxujrwu', r); }),
          fetch('./js/elite_3d_engine.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=fxujrwu', r); }),
          ...
          fetch('./js/sqlite_db.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=fxujrwu', r); }),
          fetch('./js/krishi_idb.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=fxujrwu', r); }),
          fetch('./js/krishi_worker.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=fxujrwu', r); }),
          ...
          fetch('./js/voice_assistant.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=fxujrwu', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=fxujrwu', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=fxujrwu', r); }),
