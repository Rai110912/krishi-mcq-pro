const CACHE_NAME = 'krishi-mcq-v152-m68ouib';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=m68ouib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=m68ouib', r); }),
          ...
          fetch('./js/canvas_charts.js?v=m68ouib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=m68ouib', r); }),

          fetch('./js/pwa_helpers.js?v=m68ouib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=m68ouib', r); }),
          fetch('./js/app.js?v=m68ouib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=m68ouib', r); }),
          fetch('./js/elite_animations_controller.js?v=m68ouib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=m68ouib', r); }),
          fetch('./js/elite_3d_engine.js?v=m68ouib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=m68ouib', r); }),
          ...
          fetch('./js/sqlite_db.js?v=m68ouib', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=m68ouib', r); }),
