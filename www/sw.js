const CACHE_NAME = 'krishi-mcq-v104-svwg0rh';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=svwg0rh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=svwg0rh', r); }),
          ...
          fetch('./js/canvas_charts.js?v=svwg0rh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=svwg0rh', r); }),

          fetch('./js/pwa_helpers.js?v=svwg0rh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=svwg0rh', r); }),
          fetch('./js/app.js?v=svwg0rh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=svwg0rh', r); }),
          fetch('./js/elite_animations_controller.js?v=svwg0rh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=svwg0rh', r); }),
          fetch('./js/elite_3d_engine.js?v=svwg0rh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=svwg0rh', r); }),
          ...
          fetch('./js/sqlite_db.js?v=svwg0rh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=svwg0rh', r); }),
