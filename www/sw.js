const CACHE_NAME = 'krishi-mcq-v71-doqp8qn';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=doqp8qn', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=doqp8qn', r); }),
          ...
          fetch('./js/canvas_charts.js?v=doqp8qn', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=doqp8qn', r); }),
          fetch('./js/spaced_rep.js?v=doqp8qn', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=doqp8qn', r); }),
          fetch('./js/pwa_helpers.js?v=doqp8qn', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=doqp8qn', r); }),
          fetch('./js/app.js?v=doqp8qn', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=doqp8qn', r); }),
          fetch('./js/elite_animations_controller.js?v=doqp8qn', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=doqp8qn', r); }),
          fetch('./js/elite_3d_engine.js?v=doqp8qn', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=doqp8qn', r); }),
          ...
          fetch('./js/sqlite_db.js?v=doqp8qn', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=doqp8qn', r); }),
