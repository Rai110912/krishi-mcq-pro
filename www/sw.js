const CACHE_NAME = 'krishi-mcq-v91-5cyzzig';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=5cyzzig', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=5cyzzig', r); }),
          ...
          fetch('./js/canvas_charts.js?v=5cyzzig', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=5cyzzig', r); }),
          fetch('./js/spaced_rep.js?v=5cyzzig', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=5cyzzig', r); }),
          fetch('./js/pwa_helpers.js?v=5cyzzig', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=5cyzzig', r); }),
          fetch('./js/app.js?v=5cyzzig', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=5cyzzig', r); }),
          fetch('./js/elite_animations_controller.js?v=5cyzzig', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=5cyzzig', r); }),
          fetch('./js/elite_3d_engine.js?v=5cyzzig', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=5cyzzig', r); }),
          ...
          fetch('./js/sqlite_db.js?v=5cyzzig', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=5cyzzig', r); }),
