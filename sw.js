const CACHE_NAME = 'krishi-mcq-v115-o22wsiv';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=o22wsiv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=o22wsiv', r); }),
          ...
          fetch('./js/canvas_charts.js?v=o22wsiv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=o22wsiv', r); }),

          fetch('./js/pwa_helpers.js?v=o22wsiv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=o22wsiv', r); }),
          fetch('./js/app.js?v=o22wsiv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=o22wsiv', r); }),
          fetch('./js/elite_animations_controller.js?v=o22wsiv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=o22wsiv', r); }),
          fetch('./js/elite_3d_engine.js?v=o22wsiv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=o22wsiv', r); }),
          ...
          fetch('./js/sqlite_db.js?v=o22wsiv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=o22wsiv', r); }),
