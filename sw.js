const CACHE_NAME = 'krishi-mcq-v88-aokmy6l';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=aokmy6l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=aokmy6l', r); }),
          ...
          fetch('./js/canvas_charts.js?v=aokmy6l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=aokmy6l', r); }),
          fetch('./js/spaced_rep.js?v=aokmy6l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=aokmy6l', r); }),
          fetch('./js/pwa_helpers.js?v=aokmy6l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=aokmy6l', r); }),
          fetch('./js/app.js?v=aokmy6l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=aokmy6l', r); }),
          fetch('./js/elite_animations_controller.js?v=aokmy6l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=aokmy6l', r); }),
          fetch('./js/elite_3d_engine.js?v=aokmy6l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=aokmy6l', r); }),
          ...
          fetch('./js/sqlite_db.js?v=aokmy6l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=aokmy6l', r); }),
