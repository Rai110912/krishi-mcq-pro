const CACHE_NAME = 'krishi-mcq-v85-x764het';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=x764het', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=x764het', r); }),
          ...
          fetch('./js/canvas_charts.js?v=x764het', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=x764het', r); }),
          fetch('./js/spaced_rep.js?v=x764het', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=x764het', r); }),
          fetch('./js/pwa_helpers.js?v=x764het', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=x764het', r); }),
          fetch('./js/app.js?v=x764het', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=x764het', r); }),
          fetch('./js/elite_animations_controller.js?v=x764het', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=x764het', r); }),
          fetch('./js/elite_3d_engine.js?v=x764het', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=x764het', r); }),
          ...
          fetch('./js/sqlite_db.js?v=x764het', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=x764het', r); }),
