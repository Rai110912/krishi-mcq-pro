const CACHE_NAME = 'krishi-mcq-v116-vp34bro';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=vp34bro', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=vp34bro', r); }),
          ...
          fetch('./js/canvas_charts.js?v=vp34bro', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=vp34bro', r); }),

          fetch('./js/pwa_helpers.js?v=vp34bro', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=vp34bro', r); }),
          fetch('./js/app.js?v=vp34bro', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=vp34bro', r); }),
          fetch('./js/elite_animations_controller.js?v=vp34bro', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=vp34bro', r); }),
          fetch('./js/elite_3d_engine.js?v=vp34bro', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=vp34bro', r); }),
          ...
          fetch('./js/sqlite_db.js?v=vp34bro', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=vp34bro', r); }),
