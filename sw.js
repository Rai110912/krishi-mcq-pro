const CACHE_NAME = 'krishi-mcq-v70-y7r45et';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=y7r45et', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=y7r45et', r); }),
          ...
          fetch('./js/canvas_charts.js?v=y7r45et', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=y7r45et', r); }),
          fetch('./js/spaced_rep.js?v=y7r45et', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=y7r45et', r); }),
          fetch('./js/pwa_helpers.js?v=y7r45et', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=y7r45et', r); }),
          fetch('./js/app.js?v=y7r45et', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=y7r45et', r); }),
          fetch('./js/elite_animations_controller.js?v=y7r45et', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=y7r45et', r); }),
          fetch('./js/elite_3d_engine.js?v=y7r45et', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=y7r45et', r); }),
          ...
          fetch('./js/sqlite_db.js?v=y7r45et', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=y7r45et', r); }),
