const CACHE_NAME = 'krishi-mcq-v194-a5q84xa';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=a5q84xa', r); }),
          ...
          fetch('./js/canvas_charts.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=a5q84xa', r); }),

          fetch('./js/pwa_helpers.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=a5q84xa', r); }),
          fetch('./js/app.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=a5q84xa', r); }),
          fetch('./js/elite_animations_controller.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=a5q84xa', r); }),
          fetch('./js/elite_3d_engine.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=a5q84xa', r); }),
          ...
          fetch('./js/sqlite_db.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=a5q84xa', r); }),
          fetch('./js/krishi_idb.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=a5q84xa', r); }),
          fetch('./js/krishi_worker.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=a5q84xa', r); }),
          ...
          fetch('./js/voice_assistant.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=a5q84xa', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=a5q84xa', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=a5q84xa', r); }),
