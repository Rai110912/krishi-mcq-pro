const CACHE_NAME = 'krishi-mcq-v128-udrxrcb';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=udrxrcb', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=udrxrcb', r); }),
          ...
          fetch('./js/canvas_charts.js?v=udrxrcb', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=udrxrcb', r); }),

          fetch('./js/pwa_helpers.js?v=udrxrcb', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=udrxrcb', r); }),
          fetch('./js/app.js?v=udrxrcb', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=udrxrcb', r); }),
          fetch('./js/elite_animations_controller.js?v=udrxrcb', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=udrxrcb', r); }),
          fetch('./js/elite_3d_engine.js?v=udrxrcb', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=udrxrcb', r); }),
          ...
          fetch('./js/sqlite_db.js?v=udrxrcb', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=udrxrcb', r); }),
