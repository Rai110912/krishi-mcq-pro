const CACHE_NAME = 'krishi-mcq-v145-wneupkd';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=wneupkd', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=wneupkd', r); }),
          ...
          fetch('./js/canvas_charts.js?v=wneupkd', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=wneupkd', r); }),

          fetch('./js/pwa_helpers.js?v=wneupkd', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=wneupkd', r); }),
          fetch('./js/app.js?v=wneupkd', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=wneupkd', r); }),
          fetch('./js/elite_animations_controller.js?v=wneupkd', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=wneupkd', r); }),
          fetch('./js/elite_3d_engine.js?v=wneupkd', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=wneupkd', r); }),
          ...
          fetch('./js/sqlite_db.js?v=wneupkd', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=wneupkd', r); }),
