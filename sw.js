const CACHE_NAME = 'krishi-mcq-v166-y5pl8sq';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=y5pl8sq', r); }),
          ...
          fetch('./js/canvas_charts.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=y5pl8sq', r); }),

          fetch('./js/pwa_helpers.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=y5pl8sq', r); }),
          fetch('./js/app.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=y5pl8sq', r); }),
          fetch('./js/elite_animations_controller.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=y5pl8sq', r); }),
          fetch('./js/elite_3d_engine.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=y5pl8sq', r); }),
          ...
          fetch('./js/sqlite_db.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=y5pl8sq', r); }),
          fetch('./js/krishi_idb.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=y5pl8sq', r); }),
          fetch('./js/krishi_worker.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=y5pl8sq', r); }),
          ...
          fetch('./js/voice_assistant.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=y5pl8sq', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=y5pl8sq', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=y5pl8sq', r); }),
