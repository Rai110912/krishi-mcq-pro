const CACHE_NAME = 'krishi-mcq-v149-7r7y74l';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=7r7y74l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=7r7y74l', r); }),
          ...
          fetch('./js/canvas_charts.js?v=7r7y74l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=7r7y74l', r); }),

          fetch('./js/pwa_helpers.js?v=7r7y74l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=7r7y74l', r); }),
          fetch('./js/app.js?v=7r7y74l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=7r7y74l', r); }),
          fetch('./js/elite_animations_controller.js?v=7r7y74l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=7r7y74l', r); }),
          fetch('./js/elite_3d_engine.js?v=7r7y74l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=7r7y74l', r); }),
          ...
          fetch('./js/sqlite_db.js?v=7r7y74l', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=7r7y74l', r); }),
