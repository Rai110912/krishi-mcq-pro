const CACHE_NAME = 'krishi-mcq-v99-o3bto9d';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=o3bto9d', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=o3bto9d', r); }),
          ...
          fetch('./js/canvas_charts.js?v=o3bto9d', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=o3bto9d', r); }),

          fetch('./js/pwa_helpers.js?v=o3bto9d', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=o3bto9d', r); }),
          fetch('./js/app.js?v=o3bto9d', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=o3bto9d', r); }),
          fetch('./js/elite_animations_controller.js?v=o3bto9d', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=o3bto9d', r); }),
          fetch('./js/elite_3d_engine.js?v=o3bto9d', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=o3bto9d', r); }),
          ...
          fetch('./js/sqlite_db.js?v=o3bto9d', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=o3bto9d', r); }),
