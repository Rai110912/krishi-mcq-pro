const CACHE_NAME = 'krishi-mcq-v124-silt18w';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=silt18w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=silt18w', r); }),
          ...
          fetch('./js/canvas_charts.js?v=silt18w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=silt18w', r); }),

          fetch('./js/pwa_helpers.js?v=silt18w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=silt18w', r); }),
          fetch('./js/app.js?v=silt18w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=silt18w', r); }),
          fetch('./js/elite_animations_controller.js?v=silt18w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=silt18w', r); }),
          fetch('./js/elite_3d_engine.js?v=silt18w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=silt18w', r); }),
          ...
          fetch('./js/sqlite_db.js?v=silt18w', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=silt18w', r); }),
