const CACHE_NAME = 'krishi-mcq-v81-vej2dlh';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=vej2dlh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=vej2dlh', r); }),
          ...
          fetch('./js/canvas_charts.js?v=vej2dlh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=vej2dlh', r); }),
          fetch('./js/spaced_rep.js?v=vej2dlh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=vej2dlh', r); }),
          fetch('./js/pwa_helpers.js?v=vej2dlh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=vej2dlh', r); }),
          fetch('./js/app.js?v=vej2dlh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=vej2dlh', r); }),
          fetch('./js/elite_animations_controller.js?v=vej2dlh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=vej2dlh', r); }),
          fetch('./js/elite_3d_engine.js?v=vej2dlh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=vej2dlh', r); }),
          ...
          fetch('./js/sqlite_db.js?v=vej2dlh', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=vej2dlh', r); }),
