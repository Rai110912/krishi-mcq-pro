const CACHE_NAME = 'krishi-mcq-v89-k5bcsla';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=k5bcsla', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=k5bcsla', r); }),
          ...
          fetch('./js/canvas_charts.js?v=k5bcsla', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=k5bcsla', r); }),
          fetch('./js/spaced_rep.js?v=k5bcsla', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=k5bcsla', r); }),
          fetch('./js/pwa_helpers.js?v=k5bcsla', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=k5bcsla', r); }),
          fetch('./js/app.js?v=k5bcsla', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=k5bcsla', r); }),
          fetch('./js/elite_animations_controller.js?v=k5bcsla', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=k5bcsla', r); }),
          fetch('./js/elite_3d_engine.js?v=k5bcsla', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=k5bcsla', r); }),
          ...
          fetch('./js/sqlite_db.js?v=k5bcsla', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=k5bcsla', r); }),
