const CACHE_NAME = 'krishi-mcq-v78-pk34znv';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=pk34znv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=pk34znv', r); }),
          ...
          fetch('./js/canvas_charts.js?v=pk34znv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=pk34znv', r); }),
          fetch('./js/spaced_rep.js?v=pk34znv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=pk34znv', r); }),
          fetch('./js/pwa_helpers.js?v=pk34znv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=pk34znv', r); }),
          fetch('./js/app.js?v=pk34znv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=pk34znv', r); }),
          fetch('./js/elite_animations_controller.js?v=pk34znv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=pk34znv', r); }),
          fetch('./js/elite_3d_engine.js?v=pk34znv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=pk34znv', r); }),
          ...
          fetch('./js/sqlite_db.js?v=pk34znv', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=pk34znv', r); }),
