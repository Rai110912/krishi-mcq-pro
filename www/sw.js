const CACHE_NAME = 'krishi-mcq-v103-ldboiav';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=ldboiav', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=ldboiav', r); }),
          ...
          fetch('./js/canvas_charts.js?v=ldboiav', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=ldboiav', r); }),

          fetch('./js/pwa_helpers.js?v=ldboiav', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=ldboiav', r); }),
          fetch('./js/app.js?v=ldboiav', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=ldboiav', r); }),
          fetch('./js/elite_animations_controller.js?v=ldboiav', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=ldboiav', r); }),
          fetch('./js/elite_3d_engine.js?v=ldboiav', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=ldboiav', r); }),
          ...
          fetch('./js/sqlite_db.js?v=ldboiav', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=ldboiav', r); }),
