const CACHE_NAME = 'krishi-mcq-v86-jnd8hyp';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=jnd8hyp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=jnd8hyp', r); }),
          ...
          fetch('./js/canvas_charts.js?v=jnd8hyp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=jnd8hyp', r); }),
          fetch('./js/spaced_rep.js?v=jnd8hyp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=jnd8hyp', r); }),
          fetch('./js/pwa_helpers.js?v=jnd8hyp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=jnd8hyp', r); }),
          fetch('./js/app.js?v=jnd8hyp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=jnd8hyp', r); }),
          fetch('./js/elite_animations_controller.js?v=jnd8hyp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=jnd8hyp', r); }),
          fetch('./js/elite_3d_engine.js?v=jnd8hyp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=jnd8hyp', r); }),
          ...
          fetch('./js/sqlite_db.js?v=jnd8hyp', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=jnd8hyp', r); }),
