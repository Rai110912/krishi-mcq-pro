const CACHE_NAME = 'krishi-mcq-v74-eby1j67';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=eby1j67', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=eby1j67', r); }),
          ...
          fetch('./js/canvas_charts.js?v=eby1j67', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=eby1j67', r); }),
          fetch('./js/spaced_rep.js?v=eby1j67', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=eby1j67', r); }),
          fetch('./js/pwa_helpers.js?v=eby1j67', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=eby1j67', r); }),
          fetch('./js/app.js?v=eby1j67', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=eby1j67', r); }),
          fetch('./js/elite_animations_controller.js?v=eby1j67', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=eby1j67', r); }),
          fetch('./js/elite_3d_engine.js?v=eby1j67', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=eby1j67', r); }),
          ...
          fetch('./js/sqlite_db.js?v=eby1j67', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=eby1j67', r); }),
