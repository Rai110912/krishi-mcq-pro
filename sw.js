const CACHE_NAME = 'krishi-mcq-v175-s3suo01';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=s3suo01', r); }),
          ...
          fetch('./js/canvas_charts.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=s3suo01', r); }),

          fetch('./js/pwa_helpers.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=s3suo01', r); }),
          fetch('./js/app.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=s3suo01', r); }),
          fetch('./js/elite_animations_controller.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=s3suo01', r); }),
          fetch('./js/elite_3d_engine.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=s3suo01', r); }),
          ...
          fetch('./js/sqlite_db.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=s3suo01', r); }),
          fetch('./js/krishi_idb.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=s3suo01', r); }),
          fetch('./js/krishi_worker.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=s3suo01', r); }),
          ...
          fetch('./js/voice_assistant.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=s3suo01', r); }),
          fetch('./js/ambient_player.js', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/ambient_player.js', r); }),
fetch('./js/data_safety.js?v=s3suo01', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/data_safety.js?v=s3suo01', r); }),
