const CACHE_NAME = 'krishi-mcq-v72-sj5dz6f';;
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=sj5dz6f', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=sj5dz6f', r); }),
          ...
          fetch('./js/canvas_charts.js?v=sj5dz6f', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=sj5dz6f', r); }),
          fetch('./js/spaced_rep.js?v=sj5dz6f', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/spaced_rep.js?v=sj5dz6f', r); }),
          fetch('./js/pwa_helpers.js?v=sj5dz6f', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=sj5dz6f', r); }),
          fetch('./js/app.js?v=sj5dz6f', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=sj5dz6f', r); }),
          fetch('./js/elite_animations_controller.js?v=sj5dz6f', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=sj5dz6f', r); }),
          fetch('./js/elite_3d_engine.js?v=sj5dz6f', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=sj5dz6f', r); }),
          ...
          fetch('./js/sqlite_db.js?v=sj5dz6f', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=sj5dz6f', r); }),
