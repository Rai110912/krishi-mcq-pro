const CACHE_NAME = 'krishi-mcq-v141-w07fwgx';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=w07fwgx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=w07fwgx', r); }),
          ...
          fetch('./js/canvas_charts.js?v=w07fwgx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=w07fwgx', r); }),

          fetch('./js/pwa_helpers.js?v=w07fwgx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=w07fwgx', r); }),
          fetch('./js/app.js?v=w07fwgx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=w07fwgx', r); }),
          fetch('./js/elite_animations_controller.js?v=w07fwgx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=w07fwgx', r); }),
          fetch('./js/elite_3d_engine.js?v=w07fwgx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=w07fwgx', r); }),
          ...
          fetch('./js/sqlite_db.js?v=w07fwgx', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=w07fwgx', r); }),
