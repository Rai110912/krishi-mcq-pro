const CACHE_NAME = 'krishi-mcq-v160-msx5vk9';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=msx5vk9', r); }),
          ...
          fetch('./js/canvas_charts.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=msx5vk9', r); }),

          fetch('./js/pwa_helpers.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=msx5vk9', r); }),
          fetch('./js/app.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=msx5vk9', r); }),
          fetch('./js/elite_animations_controller.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=msx5vk9', r); }),
          fetch('./js/elite_3d_engine.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=msx5vk9', r); }),
          ...
          fetch('./js/sqlite_db.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=msx5vk9', r); }),
          fetch('./js/krishi_idb.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=msx5vk9', r); }),
          fetch('./js/krishi_worker.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=msx5vk9', r); }),
          ...
          fetch('./js/voice_assistant.js?v=msx5vk9', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=msx5vk9', r); }),
