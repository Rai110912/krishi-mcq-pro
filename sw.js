const CACHE_NAME = 'krishi-mcq-v161-zucafny';
    ...
    caches.open(CACHE_NAME)
      .then(cache => {
        ...
        return Promise.all([
          ...
          fetch('./index.css?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./index.css?v=zucafny', r); }),
          ...
          fetch('./js/canvas_charts.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/canvas_charts.js?v=zucafny', r); }),

          fetch('./js/pwa_helpers.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/pwa_helpers.js?v=zucafny', r); }),
          fetch('./js/app.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/app.js?v=zucafny', r); }),
          fetch('./js/elite_animations_controller.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_animations_controller.js?v=zucafny', r); }),
          fetch('./js/elite_3d_engine.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/elite_3d_engine.js?v=zucafny', r); }),
          ...
          fetch('./js/sqlite_db.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/sqlite_db.js?v=zucafny', r); }),
          fetch('./js/krishi_idb.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_idb.js?v=zucafny', r); }),
          fetch('./js/krishi_worker.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/krishi_worker.js?v=zucafny', r); }),
          ...
          fetch('./js/voice_assistant.js?v=zucafny', { cache: 'reload' }).then(r => { if (r.ok) cache.put('./js/voice_assistant.js?v=zucafny', r); }),
